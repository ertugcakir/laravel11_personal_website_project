...
@section('seo_title')
{{ $page_data->blog_seo_title }}@endsection

@section('seo_meta_description')
{{ $page_data->blog_seo_meta_description }}@endsection
...
<div class="page-content blog">
        <div class="container">
            <div class="row">
                ...
                @if(count($posts)==0)
                    <div class="alert alert-info"><i class="fa fa-info-circle"></i>Herhangi bir yazı bulunamadı.</div>
                @endif
