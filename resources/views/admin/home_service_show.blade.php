...
@section('heading', 'Servis Bölümü Ayarları')
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <input type="number" class="form-control" name="service_total" value="{{ $page_data->service_total }}">
                                                </div>
                                                <div class="mb-4">
                                                    <label class="form-label">Status</label>
                                                    <select name="service_status" class="form-control">
                                                        <option value="1" @if($page_data->service_status==1) selected @endif>Show</option>
                                                        <option value="0" @if($page_data->service_status==0) selected @endif>Hide</option>
                                                    </select>
                                                </div>
                                                <div class="mb-4">
