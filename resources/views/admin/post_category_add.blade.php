...
@section('heading', 'Blog Kategori Ekleme Formu')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" class="form-control" name="category_name" onchange="permalink(this.value)" value="{{ old('category_name') }}">
                                                </div>
                                                <div class="mb-4">
                                                    <label class="form-label">Slug (SEF Link)*</label>
                                                    <input type="text" class="form-control" name="category_slug" id="slug" value="{{ old('category_slug') }}">
                                                </div>

                                                <div class="mb-4">
                                                    <label class="form-label">Kategori Arkaplanı </label>
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" class="form-control" name="category_seo_meta_description" value="{{ old('category_seo_meta_description') }}">
                                                </div>
