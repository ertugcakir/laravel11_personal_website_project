...
@section('heading', 'Eğitim Programı Düzenleme Formu')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" class="form-control" name="program" value="{{ $row_data->program }}">
                                                </div>
                                                <div class="mb-4">
                                                    <label class="form-label">University*</label>
                                                    <input type="text" class="form-control" name="university" value="{{ $row_data->university }}">
                                                </div>
                                                <div class="mb-4">
