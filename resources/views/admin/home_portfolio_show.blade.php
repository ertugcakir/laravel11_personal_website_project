...
@section('heading', 'Portfolio Bölümü Ayarları')
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select name="portfolio_status" class="form-control">
                                                        <option value="1" @if($page_data->portfolio_status==1) selected @endif>Show</option>
                                                        <option value="0" @if($page_data->portfolio_status==0) selected @endif>Hide</option>
                                                    </select>
                                                </div>
                                                <div class="mb-4">
